    ...
    <>
          ...
          {universes.map((u, i) => (
            <Reveal key={u.id} y={10} delay={0.02 * i}>
              <Link href={`/univers/${u.slug}`} className="group grid items-center gap-6 border-b border-stone py-6 lg:grid-cols-12 lg:gap-10 lg:py-7">
                <span className="hidden font-display text-sm italic text-champagne-2 lg:col-span-1 lg:block">{String(i + 1).padStart(2, "0")}</span>
      ...
      <section className="border-y border-stone bg-cream">
        <div className="container-lux py-section-sm lg:py-section">
          <Reveal><SectionHeading index="03" eyebrow="La sélection" title="Les essentiels de nos pharmaciens" description="Huit références que nous conseillons chaque jour en boutique — tolérance, efficacité, transparence." action={{ href: "/boutique?sort=bestsellers", label: "Meilleures ventes" }} /></Reveal>
      ...
      <section className="bg-noir text-paper">
        <div className="container-lux grid gap-14 py-section-sm lg:grid-cols-12 lg:py-section">
          <div className="lg:col-span-4">
            <Reveal>
              <p className="eyebrow mb-6 flex items-center gap-3 text-paper/55"><span className="font-display text-lg italic text-champagne-3">04</span> Offres du moment</p>
        ...
        <div className="container-lux grid gap-12 py-section-sm lg:grid-cols-12 lg:py-section">
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              <Reveal>
                <p className="eyebrow mb-6 flex items-center gap-3"><span className="font-display text-lg italic text-champagne-2">05</span> Par besoin</p>
              ...
              <StaggerItem key={c.id}>
                <Link href={`/besoin/${c.slug}`} className="group flex h-full items-center justify-between gap-4 px-5 py-6 transition-colors duration-500 hover:bg-cream sm:px-7">
                  <div>
                    ...
                    <p className="mt-2 line-clamp-2 pl-9 text-xs leading-relaxed text-muted">{c.intro}</p>
                  </div>
      ...
      <section className="border-b border-stone bg-cream">
        <div className="container-lux grid gap-12 py-section-sm lg:grid-cols-12 lg:py-section">
          <div className="lg:col-span-5">
            <Reveal>
              <p className="eyebrow mb-6 flex items-center gap-3"><span className="font-display text-lg italic text-champagne-2">06</span> Nos marques</p>
                ...
                <StaggerItem key={b.id}>
                  <Link href={`/marque/${b.slug}`} className="group flex h-full flex-col justify-between gap-10 bg-cream p-7 transition-colors duration-500 hover:bg-paper lg:min-h-44">
                    <p className="flex items-baseline justify-between">
                      ...
                      <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-muted-2">{String(i + 1).padStart(2, "0")}</span>
                    </p>
      ...
      <section className="border-b border-stone bg-paper">
        <div className="container-lux py-section-sm lg:py-section">
          <Reveal><SectionHeading index="07" eyebrow="Le Journal" title="Comprendre avant d'acheter" description="Des articles courts et honnêtes, écrits par nos pharmaciens." action={{ href: "/journal", label: "Tous les articles" }} /></Reveal>
      ...
      <section className="bg-cream">
        <div className="container-lux grid items-center gap-12 py-section-sm lg:grid-cols-12 lg:py-section">
          ...
          <div className="order-1 lg:order-2 lg:col-span-6">
            <Reveal>
              <p className="eyebrow mb-6 flex items-center gap-3"><span className="font-display text-lg italic text-champagne-2">08</span> La maison</p>
